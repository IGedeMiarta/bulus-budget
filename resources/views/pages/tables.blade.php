                                ...
                                <table class="ti-custom-table ti-custom-table-head">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="text-end font-medium">
                                                <a class="text-primary hover:text-primary"
                                                    href="javascript:void(0);">Footer</a>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body p-0">
                            <div class="overflow-auto">
                                <table class="ti-custom-table ti-custom-table-head">
                                    <caption class="py-2 px-4 text-start text-sm text-gray-600 dark:text-white/70">List of
                                        users</caption>
                                    <thead>
                                        <tr>
                                            <th scope="col">Name</th>
                                    ...
                                    <table class="ti-custom-table ti-custom-table-head">
                                        ...
                                        <tbody class="">
                                                ...
                                                <td class="py-3">
                                                    <div class="flex items-center h-5">
                                                        <input id="hs-table-search-checkbox-2" type="checkbox"
                                                            class="ti-form-checkbox">
                                                        <label for="hs-table-search-checkbox-2"
                                                            class="sr-only">Checkbox</label>
                                                    </div>
                                                </td>
                                                <td class="font-medium">Jim Green</td>
                                            ...
                                            <tr>
                                                <td class="py-3">
                                                    <div class="flex items-center h-5">
                                                        <input id="hs-table-search-checkbox-3" type="checkbox"
                                                            class="ti-form-checkbox">
                                                        <label for="hs-table-search-checkbox-3"
                                                            class="sr-only">Checkbox</label>
                                                    </div>
                                                </td>
                                                <td class="font-medium">Joe Black</td>
                                            ...
                                            <tr>
                                                <td class="py-3">
                                                    <div class="flex items-center h-5">
                                                        <input id="hs-table-search-checkbox-4" type="checkbox"
                                                            class="ti-form-checkbox">
                                                        <label for="hs-table-search-checkbox-4"
                                                            class="sr-only">Checkbox</label>
                                                    </div>
                                                </td>
                                                <td class="font-medium">Edward King</td>
                                            ...
                                            <tr>
                                                <td class="py-3">
                                                    <div class="flex items-center h-5">
                                                        <input id="hs-table-search-checkbox-5" type="checkbox"
                                                            class="ti-form-checkbox">
                                                        <label for="hs-table-search-checkbox-5"
                                                            class="sr-only">Checkbox</label>
                                                    </div>
                                                </td>
                                                <td class="font-medium">Jim Red</td>
                                    ...
                                    <table class="ti-custom-table ti-custom-table-head">
                                        ...
                                        <tbody class="">
                                            <tr>
                                                <td class="py-3">
                                                    <div class="flex items-center h-5">
                                                        <input id="hs-table-search-checkbox-11" type="checkbox"
                                                            class="ti-form-checkbox">
                                                        <label for="hs-table-search-checkbox-11"
                                                            class="sr-only">Checkbox</label>
                                                    </div>
                                                </td>
                                                <td class="font-medium">John Brown</td>
                                            ...
                                            <tr>
                                                <td class="py-3">
                                                    <div class="flex items-center h-5">
                                                        <input id="hs-table-search-checkbox-12" type="checkbox"
                                                            class="ti-form-checkbox">
                                                        <label for="hs-table-search-checkbox-12"
                                                            class="sr-only">Checkbox</label>
                                                    </div>
                                                </td>
                                                <td class="font-medium">Jim Green</td>
                                            ...
                                            <tr>
                                                <td class="py-3">
                                                    <div class="flex items-center h-5">
                                                        <input id="hs-table-search-checkbox-13" type="checkbox"
                                                            class="ti-form-checkbox">
                                                        <label for="hs-table-search-checkbox-13"
                                                            class="sr-only">Checkbox</label>
                                                    </div>
                                                </td>
                                                <td class="font-medium">Joe Black</td>
                                            ...
                                            <tr>
                                                <td class="py-3">
                                                    <div class="flex items-center h-5">
                                                        <input id="hs-table-search-checkbox-14" type="checkbox"
                                                            class="ti-form-checkbox">
                                                        <label for="hs-table-search-checkbox-14"
                                                            class="sr-only">Checkbox</label>
                                                    </div>
                                                </td>
                                                <td class="font-medium">Edward King</td>
                                            ...
                                            <tr>
                                                <td class="py-3">
                                                    <div class="flex items-center h-5">
                                                        <input id="hs-table-search-checkbox-15" type="checkbox"
                                                            class="ti-form-checkbox">
                                                        <label for="hs-table-search-checkbox-15"
                                                            class="sr-only">Checkbox</label>
                                                    </div>
                                                </td>
                                                <td class="font-medium">Jim Red</td>
                                ...
                                <table class="ti-custom-table ti-custom-table-head ti-head-primary">
                                    <thead class="">
                                        <tr class="!divide-primary/10 dark:!divide-primary/10 ">
                                            ...
                                            <th scope="col" class="!text-end !text-gray-800  dark:!text-white/70">
                                                Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                <table class="ti-custom-table ti-custom-table-head ti-head-success">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>New York No. 1 Lake Park</td>
                                            <td class="text-end font-medium">
                                                <a class="text-success hover:text-success"
                                                    href="javascript:void(0);">Delete</a>
                                            </td>
                                        </tr>
                                ...
                                <table class="ti-custom-table ti-custom-table-head">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>New York No. 1 Lake Park</td>
                                            <td class="text-end font-medium">
                                                <a class="text-info hover:text-info"
                                                    href="javascript:void(0);">Delete</a>
                                            </td>
                                        </tr>
            ...
            <div class="grid grid-cols-12 gap-x-6">
                <div class="col-span-12 lg:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div
                                class="overflow-auto table-primary rounded-sm border border-gray-200 dark:border-white/10">
                                <table class="ti-custom-table ti-custom-table-head">
                                    <thead>
                                        <tr>
                                            <th scope="col">Name</th>
                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div
                                class="overflow-auto table-secondary rounded-sm border border-gray-200 dark:border-white/10">
                                <table class="ti-custom-table ti-custom-table-head">
                                    <thead>
                                        <tr>
                                            <th scope="col">Name</th>
                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div
                                class="overflow-auto table-warning rounded-sm border border-gray-200 dark:border-white/10">
                                <table class="ti-custom-table ti-custom-table-head">
                                    <thead>
                                        <tr>
                                            <th scope="col">Name</th>
                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div
                                class="overflow-auto table-danger rounded-sm border border-gray-200 dark:border-white/10">
                                <table class="ti-custom-table ti-custom-table-head">
                                    <thead>
                                        <tr>
                                            <th scope="col">Name</th>
                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div
                                class="overflow-auto table-success rounded-sm border border-gray-200 dark:border-white/10">
                                <table class="ti-custom-table ti-custom-table-head">
                                    <thead>
                                        <tr>
                                            <th scope="col">Name</th>
