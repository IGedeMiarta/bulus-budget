            ...
            <div class="grid grid-cols-12 gap-x-6">
                ...
                <div class="col-span-12 sm:col-span-6 xl:!col-span-3">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div id="hs-static-backdrop-modal" class="hs-overlay hidden ti-modal"
                                data-hs-overlay-keyboard="false" data-hs-overlay-backdrop="static">
                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                    <div class="ti-modal-content">
                                        <div class="ti-modal-header">
                                            <h3 class="ti-modal-title">
                                ...
                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out h-[calc(100%-3.5rem)]">
                                    <div class="max-h-full overflow-hidden ti-modal-content">
                                        ...
                                        <div class="ti-modal-body ">
                                            <div class="space-y-4">
                                                <div>
                                                    <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Be bold
                                                    </h3>
                                                    <p class="mt-1 text-gray-800 dark:text-white/70">
                                                        Motivate teams to do their best work. Offer best practices to get
                                                        users going in the right
                                                        direction. Be bold and offer just enough help to get the work
                                                        started, and then get out of
                                                        the way. Give accurate information so users can make educated
                                                        decisions. Know your user's
                                                        struggles and desired outcomes and give just enough information to
                                                        let them get where they
                                                        need to go.
                                                    </p>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mt-1 text-gray-800 dark:text-white/70">
                                                        ...
                                                        across our fabric and be diligent about vocabulary across all
                                                        messaging by being brand
                                                        conscious across products to create a seamless flow across all the
                                                        things. Let people know
                                                        that they can jump in and start working expecting to find a
                                                        dependable experience across
                                                        all the things. Keep teams in the loop about what is happening by
                                                        informing them of
                                                        relevant features, products and opportunities for success. Be on the
                                                        journey with them and
                                                        highlight the key points that will help them the most - right now.
                                                        Be in the moment by
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mt-1 text-gray-800 dark:text-white/70">
                                                        ...
                                                        Get to the point and be
                                                        direct. Be concise - we tell the story of how we can help, but we do
                                                        it directly and with
                                                        purpose. Be on the lookout for opportunities and be quick to offer a
                                                        helping hand. At the
                                                        same time realize that nobody likes a nosy neighbor. Give the user
                                                        just enough to know
                                                        that something awesome is around the corner and then get out of the
                                                        way. Write clear,
                                                        accurate, and concise text that makes interusers more usable and
                                                        consistent - and builds
                                                        trust. We strive to write text that is understandable by anyone,
                                                        anywhere, regardless of
                                                        their culture or language so that everyone feels they are part of
                                                        the team.
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mt-1 text-gray-800 dark:text-white/70">
                                                        ...
                                                        purpose. Be on the lookout for opportunities and be quick to offer a
                                                        helping hand. At the
                                                        same time realize that novbody likes a nosy neighbor. Give the user
                                                        just enough to know
                                                        that something awesome is around the corner and then get out of the
                                                        way. Write clear,
                                                        accurate, and concise text that makes interusers more usable and
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mt-1 text-gray-800 dark:text-white/70">
                                                        ...
                                                        the same time realize that novbody likes a nosy neighbor. Give the
                                                        ...
                                                        that makes interusers more usable and consistent - and builds trust.
                ...
                <div class="col-span-12 sm:col-span-6 xl:!col-span-7">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <button type="button" class="m-1 ml-0 ti-btn ti-btn-primary"
                            ...
                            <div id="hs-full-screen-modal-below-sm" class="hs-overlay hidden ti-modal">
                                <div
                                    class="hs-overlay-open:mt-0 ti-modal-box mt-10 max-w-full w-full !m-0 sm:hs-overlay-open:!mt-10 sm:!mt-0 sm:max-w-lg sm:!mx-auto">
                                    <div
                                        class="ti-modal-content sm:border sm:rounded-sm sm:shadow-sm dark:bg-bgdark sm:dark:border-white/10">
                                        <div class="ti-modal-header">
                                            <h3 class="ti-modal-title">
                                                Modal title
                                            </h3>
                            ...
                            <div id="hs-full-screen-modal-below-md" class="hs-overlay hidden ti-modal">
                                <div
                                    class="hs-overlay-open:mt-0 ti-modal-box mt-10 max-w-full w-full !m-0 md:hs-overlay-open:!mt-10 md:!mt-0 md:max-w-lg md:!mx-auto">
                                    <div
                                        class="ti-modal-content md:border md:rounded-sm md:shadow-sm md:dark:border-white/10">
                                        <div class="ti-modal-header">
                                            <h3 class="ti-modal-title">
                                                Modal title
                                            </h3>
                            ...
                            <div id="hs-full-screen-modal-below-lg" class="hs-overlay hidden ti-modal">
                                <div
                                    class="hs-overlay-open:mt-0 ti-modal-box mt-10 max-w-full w-full !m-0 lg:hs-overlay-open:!mt-10 lg:!mt-0 lg:max-w-lg lg:!mx-auto">
                                    <div
                                        class="ti-modal-content lg:border lg:rounded-sm lg:shadow-sm lg:dark:border-white/10">
                                        <div class="ti-modal-header">
                                            <h3 class="ti-modal-title">
                                                Modal title
                                            </h3>
                            ...
                            <div id="hs-full-screen-modal-below-xl" class="hs-overlay hidden ti-modal">
                                <div
                                    class="hs-overlay-open:mt-0 ti-modal-box mt-10 max-w-full w-full !m-0  xl:hs-overlay-open:!mt-10 xl:!mt-0 xl:max-w-xl xl:!mx-auto">
                                    <div
                                        class="ti-modal-content xl:border xl:rounded-sm xl:shadow-sm xl:dark:border-white/10">
                                        <div class="ti-modal-header">
                                            <h3 class="ti-modal-title">
                                                Modal title
                                            </h3>
