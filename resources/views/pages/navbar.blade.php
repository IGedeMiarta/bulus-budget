                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <header
                                ...
                                <nav class=" w-full mx-auto sm:px-4 sm:flex sm:items-center sm:justify-between"
                                    aria-label="Global">
                                    <a href="{{ url('index') }}" class="header-logo">
                                        <img src="{{ asset('build/assets/img/brand-logos/desktop-logo.png') }}"
                                            alt="logo" class="dark:hidden block">
                                        <img src="{{ asset('build/assets/img/brand-logos/desktop-dark.png') }}"
                                    ...
                                    <div
                                        ...
                                        <a class="font-medium text-primary" href="javascript:void(0);"
                ...
                <div class="col-span-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <header
                                class="flex flex-wrap sm:justify-start sm:flex-nowrap z-40 w-full bg-white text-sm dark:bg-bgdark">
                                <nav class="w-full mx-auto px-4 xxl:flex xxl:items-center xxl:justify-between"
                                    aria-label="Global">
                                    <a href="{{ url('index') }}" class="header-logo">
                                        <img src="{{ asset('build/assets/img/brand-logos/desktop-logo.png') }}"
                                            alt="logo" class="dark:hidden block">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="sm:hidden">
                                            <button type="button"
                                                ...
                                                aria-controls="navbar-with-mega-menu" aria-label="Toggle navigation">
                                                <svg class="hs-collapse-open:hidden w-4 h-4" width="16"
                                                    height="16" fill="currentColor" viewBox="0 0 16 16">
                                                    <path fill-rule="evenodd"
                                                        d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z" />
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <button id="hs-mega-menu-basic-dr" type="button"
                                                    ...
                                                    Dropdown
                                                    <svg class="ltr:ml-2 rtl:mr-2 w-2.5 h-2.5 text-gray-600"
                                                ...
                                                <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] sm:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 sm:w-48 z-10 bg-white sm:shadow-md rounded-lg p-2 dark:bg-gray-800 sm:dark:border dark:border-gray-700 dark:divide-gray-700 before:absolute top-full sm:border before:-top-5 before:left-0 before:w-full before:h-5 hidden"
                                                    style="">
                                                    <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-0 focus:ring-primary dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                                                        href="javascript:void(0);">
                                                        About
                                                    </a>
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            class="flex justify-between w-full items-center text-sm text-gray-800 rounded-md py-2 px-3 hover:bg-gray-100 focus:ring-0 focus:ring-primary dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                                                            Sub Menu
                                                            <svg class="sm:-rotate-90 ml-2 w-2.5 h-2.5 text-gray-600"
                        ...
                        <div class="box-body space-y-4">
                            <header
                                ...
                                <nav class="w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <a href="{{ url('index') }}" class="header-logo">
                                            <img src="{{ asset('build/assets/img/brand-logos/desktop-light.png') }}"
                                    ...
                                    <div id="navbar-primary"
                                        ...
                                        <div
                                            class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 ltr:sm:pl-5 rtl:sm:pr-5">
                                            <a class="font-medium text-white" href="javascript:void(0);"
                                                aria-current="page">Landing</a>
