            ...
            <div class="grid grid-cols-12 gap-x-6">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="bg-primary/10 border border-primary/10 alert text-primary" role="alert">
                                <span class="font-bold">Primary</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-secondary/10 border border-secondary/10 alert text-secondary" role="alert">
                                <span class="font-bold">Secondary</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-danger/10 border border-danger/10 alert text-danger" role="alert">
                                <span class="font-bold">Danger</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            ...
                            <div class="bg-success/10 border border-success/10 alert text-success" role="alert">
                                <span class="font-bold">Success</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-white/[.1] border border-gray-200 dark:border-gray-800 text-gray-600 dark:text-gray-400 alert"
                                role="alert">
                                <span class="font-bold">Light</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-gray-800/[.1] border border-gray-200 text-gray-600 dark:bg-gray-900/[.1] dark:border-gray-700 dark:text-white alert"
                                role="alert">
                ...
                <div class="col-span-12 xl:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="bg-primary/10 border border-primary/10 alert text-primary" role="alert">A simple
                                primary
                                alert with <a href="javascript:void(0);" class="font-bold text-primary">an example link</a>
                                Give it a click if you like.
                            </div>
                            <div class="bg-secondary/10 border border-secondary/10 alert text-secondary" role="alert">A
                                simple
                                secondary alert with <a href="javascript:void(0);" class="font-bold text-secondary">an
                                    example link</a> Give it a click
                                if you like.
                            </div>
                            <div class="bg-danger/10 border border-danger/10 alert text-danger" role="alert">A simple
                                danger alert
                                with <a href="javascript:void(0);" class="font-bold text-danger">an example link</a> Give it
                                a click if you like.
                            </div>
                            <div class="bg-warning/10 border border-warning/10 alert text-warning" role="alert">A simple
                                warning
                                alert with <a href="javascript:void(0);" class="font-bold text-warning">an example link</a>
                                Give it a click if you like.
                            </div>
                            <div class="bg-info/10 border border-info/10 alert text-info" role="alert">A simple info alert
                                with <a href="javascript:void(0);" class="font-bold text-info">an example link</a> Give it a
                                click if you like.
                            </div>
                            <div class="bg-success/10 border border-success/10 alert text-success" role="alert">A simple
                                success
                                alert with <a href="javascript:void(0);" class="font-bold text-success">an example link</a>
                                Give it a click if you like.
                            </div>
                            <div class="bg-white/[.1] border border-gray-200 dark:border-gray-800 text-gray-600 dark:text-gray-400 alert"
                                role="alert">A
                                simple Light alert with <a href="javascript:void(0);"
                                    class="font-bold text-gray-600 dark:text-white">an example
                                    link</a> Give it a click if you like.
                            </div>
                            <div class="bg-gray-800/[.1] border border-gray-200 text-gray-600 dark:bg-gray-900/[.1] dark:border-gray-700 dark:text-white alert"
                                role="alert">A simple Dark alert with <a href="javascript:void(0);"
                                    class="font-bold text-gray-600 dark:text-white">an
                ...
                <div class="col-span-12 xl:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="bg-white dark:bg-bgdark border border-secondary alert text-secondary"
                                role="alert">
                                <span class="font-bold">Secondary</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            ...
                            <div class="bg-white dark:bg-bgdark border border-gray-200 dark:border-white/10 alert text-gray-600 dark:text-white/70"
                                role="alert">
                                <span class="font-bold">Light</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-white dark:bg-bgdark border border-gray-900 alert text-gray-900 dark:border-white/10 dark:text-gray-100"
                                role="alert">
                                <span class="font-bold">Dark</span> alert! You should check in on some of those fields
                                below.
                            </div>
            ...
            <div class="grid grid-cols-12 gap-x-6">
                <div class="col-span-12 xl:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="bg-primary border border-primary text-white alert rounded-full px-6"
                                role="alert">
                                <span class="font-bold">Primary</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-secondary border border-secondary text-white alert rounded-full px-6"
                                role="alert">
                                <span class="font-bold">Secondary</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            ...
                            <div class="bg-warning border border-warning text-white alert rounded-full px-6"
                                role="alert">
                                <span class="font-bold">Warning</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            ...
                            <div class="bg-success  border border-success text-white alert rounded-full px-6"
                                role="alert">
                                <span class="font-bold">Success</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-gray-100 border border-gray-200 text-gray-600 alert rounded-full px-6"
                                role="alert">
                                <span class="font-bold">Light</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-black/20 border border-white/10 text-white alert dark:bg-gray-900 dark:text-white rounded-full px-6"
                                role="alert">
                                <span class="font-bold">Dark</span> alert! You should check in on some of those fields
                                below.
                            </div>
                ...
                <div class="col-span-12 xl:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="bg-white dark:bg-bgdark border border-primary alert rounded-full  px-6 text-primary"
                                role="alert">
                                <span class="font-bold">Primary</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            ...
                            <div class="bg-white dark:bg-bgdark border border-danger alert rounded-full px-6 text-danger"
                                role="alert">
                                <span class="font-bold">Danger</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-white dark:bg-bgdark border border-warning alert rounded-full px-6 text-warning"
                                role="alert">
                                <span class="font-bold">Warning</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-white dark:bg-bgdark border border-info alert rounded-full px-6 text-info"
                                role="alert">
                                <span class="font-bold">info</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-white dark:bg-bgdark border border-success alert rounded-full px-6 text-success"
                                role="alert">
                                <span class="font-bold">Success</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-white dark:bg-bgdark border border-gray-200 dark:border-white/10 alert rounded-full px-6 text-gray-600 dark:text-white/70"
                                role="alert">
                                <span class="font-bold">Light</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-white dark:bg-bgdark border border-gray-900 alert rounded-full px-6 text-gray-900 dark:border-gray-900 dark:text-gray-100"
                                role="alert">
                                <span class="font-bold">Dark</span> alert! You should check in on some of those fields
                                below.
                            </div>
            ...
            <div class="grid grid-cols-12 gap-x-6">
                        ...
                        <div class="box-body">
                            <div class="bg-primary border border-primary text-white alert rounded-sm" role="alert">
                                <img src="{{ asset('build/assets/img/users/3.jpg') }}"
                                    class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                <span class="font-bold">Primary</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            ...
                            <div class="bg-success  border border-success text-white alert rounded-sm" role="alert">
                                <img src="{{ asset('build/assets/img/users/14.jpg') }}"
                                    class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                <span class="font-bold">Success</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-gray-100 border border-gray-200 text-gray-600 alert rounded-sm" role="alert">
                                <img src="{{ asset('build/assets/img/users/12.jpg') }}"
                                    class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                <span class="font-bold">Light</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-black/20 border border-white/10 text-white alert dark:bg-gray-900 dark:text-white rounded-sm"
                                role="alert">
                ...
                <div class="col-span-12 xl:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="bg-white dark:bg-bgdark border border-primary alert rounded-sm text-primary"
                                role="alert">
                                <img src="{{ asset('build/assets/img/users/3.jpg') }}"
                                    class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                <span class="font-bold">Primary</span> alert! You should check in on some of those fields
                            ...
                            <div class="bg-white dark:bg-bgdark border border-danger alert rounded-sm text-danger"
                                role="alert">
                                <img src="{{ asset('build/assets/img/users/4.jpg') }}"
                                    class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                <span class="font-bold">Danger</span> alert! You should check in on some of those fields
                            ...
                            <div class="bg-white dark:bg-bgdark border border-warning alert rounded-sm text-warning"
                                role="alert">
                                <img src="{{ asset('build/assets/img/users/6.jpg') }}"
                                    class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                <span class="font-bold">Warning</span> alert! You should check in on some of those fields
                            ...
                            <div class="bg-white dark:bg-bgdark border border-info alert rounded-sm text-info"
                                role="alert">
                                <img src="{{ asset('build/assets/img/users/16.jpg') }}"
                                    class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                <span class="font-bold">info</span> alert! You should check in on some of those fields
                            ...
                            <div class="bg-white dark:bg-bgdark border border-success alert rounded-sm text-success"
                                role="alert">
                                <img src="{{ asset('build/assets/img/users/14.jpg') }}"
                                    class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                <span class="font-bold">Success</span> alert! You should check in on some of those fields
                            ...
                            <div class="bg-white dark:bg-bgdark border border-gray-200 dark:border-white/10 alert rounded-sm text-gray-600 dark:text-white/70"
                                role="alert">
                                <img src="{{ asset('build/assets/img/users/12.jpg') }}"
                                    class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                <span class="font-bold">Light</span> alert! You should check in on some of those fields
                            ...
                            <div class="bg-white dark:bg-bgdark border border-gray-900 alert rounded-sm text-gray-900 dark:border-white/10 dark:text-gray-100"
                                role="alert">
                                <img src="{{ asset('build/assets/img/users/5.jpg') }}"
                                    class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                <span class="font-bold">Dark</span> alert! You should check in on some of those fields
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="bg-primary border border-primary text-white alert rounded-full px-6"
                                role="alert">
                                <img src="{{ asset('build/assets/img/users/3.jpg') }}"
                                    class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-full ring-0" alt="user-img">
                                <span class="font-bold">Primary</span> alert! You should check in on some of those fields
                                below.
                            </div>
                            <div class="bg-secondary border border-secondary text-white alert rounded-full px-6"
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="bg-primary/10 border border-primary alert mb-0" role="alert">
                                <div class="flex">
                                    <div class="flex-shrink-0">
                                        <svg class="h-4 w-4 text-primary mt-1" xmlns="http://www.w3.org/2000/svg"
                                            width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                            <path
                                                d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z" />
                                        </svg>
            ...
            <div class="grid grid-cols-12 gap-x-6">
                ...
                <div class="col-span-12 xl:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="bg-white border shadow-lg alert mb-0 dark:bg-bgdark dark:border-white/10"
                                role="alert">
                                <div class="flex">
                                    <div class="flex-shrink-0">
