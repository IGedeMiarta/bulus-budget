                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <div
                                            ...
                                            <svg class="h-4 w-4 text-red-500" width="16" height="16"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <div
                                            class="absolute inset-y-0 ltr:right-0 rtl:left-0 flex items-center pointer-events-none ltr:pr-8 rtl:pl-8">
                                            <svg class="h-4 w-4 text-green-500" width="16" height="16"
            ...
            <div class="grid grid-cols-12 gap-x-6">
                <div class="col-span-12  md:col-span-6 xl:!col-span-3">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <input type="text" class="ti-input" id="input-tags" autocomplete="off"
                ...
                <div class="col-span-12  md:col-span-6 xl:!col-span-3">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <select class="ti-form-select !p-0" id="select-state" name="state[]" multiple
                                autocomplete="off">
                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <select class="ti-form-select" data-trigger name="choices-multiple-default"
                            ...
                            <select class="ti-form-select" name="choices-multiple-groups" id="choices-multiple-groups"
                                multiple>
                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <select class="ti-form-select" data-trigger name="choices-single-default"
                            ...
                            <label class="ti-form-select-label">Option groups</label>
                            <select class="ti-form-select" data-trigger name="choices-single-groups"
            ...
            <div class="grid grid-cols-12 gap-x-6">
                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <input class="ti-form-input custom class" id="choices-text-unique-values" type="text"
