                        ...
                        <div class="box-body">
                            <div class="flex">
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    ...
                                    <h6 class="text-lg font-medium text-gray-800 mb-2 dark:text-white my-auto">Total Sales
                                    </h6>
                                </div>
                        ...
                        <div class="box-body">
                            <div class="flex">
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    ...
                                    <h6 class="text-lg font-medium text-gray-800 mb-2 dark:text-white my-auto">Total
                                        Products</h6>
                                </div>
                                        ...
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                                <img class="avatar avatar-sm rounded-full"
                                                    src="{{ asset('build/assets/img/ecommerce/jpg/1.jpg') }}"
                                                    alt="image">
                                            </div>
                                ...
                                <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                    <a href="javascript:void(0);" class="w-full">
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                                <img class="avatar avatar-sm rounded-full"
                                                    src="{{ asset('build/assets/img/ecommerce/jpg/2.jpg') }}"
                                                    alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                <p class="text-sm font-semibold mb-0">White Headphones</p>
                                                <p class="text-xs text-gray-400 dark:text-white/80 mb-0 !font-normal">Music
                                                </p>
                                            </div>
                                            <div class="block text-end">
                                ...
                                <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                    <a href="javascript:void(0);" class="w-full">
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                                <img class="avatar avatar-sm rounded-full"
                                                    src="{{ asset('build/assets/img/ecommerce/jpg/3.jpg') }}"
                                                    alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                ...
                                <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                    <a href="javascript:void(0);" class="w-full">
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                                <img class="avatar avatar-sm rounded-full"
                                                    src="{{ asset('build/assets/img/ecommerce/jpg/4.jpg') }}"
                                                    alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                ...
                                <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                    <a href="javascript:void(0);" class="w-full">
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                                <img class="avatar avatar-sm rounded-full"
                                                    src="{{ asset('build/assets/img/ecommerce/jpg/6.jpg') }}"
                                                    alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                ...
                                <li class="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white">
                                    <a href="javascript:void(0);" class="w-full">
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                                <img class="avatar avatar-sm rounded-full"
                                                    src="{{ asset('build/assets/img/ecommerce/jpg/5.jpg') }}"
                                                    alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                ...
                                <table class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                    <thead class="bg-gray-50 dark:bg-black/20">
                                        <tr class="">
                                            ...
                                            <th scope="col" class="dark:text-white/80 min-w-[300px]">Customer Details
                                            </th>
