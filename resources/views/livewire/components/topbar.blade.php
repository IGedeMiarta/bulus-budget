                                        ...
                                        <div class="py-2 first:pt-0 last:pb-0" id="allNotifyContainer">
                                            <div class="ti-dropdown-item relative header-box">
                                                <a href="{{ url('mail-inbox') }}"
                                                    ...
                                                    <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                                                        <img src="{{ asset('build/assets/img/users/17.jpg') }}"
                                                    ...
                                                    <div class="relative w-full">
                                                        <h5
                                                            ...
                                                            Elon Isk</h5>
                                                        <p class="text-xs mb-1 max-w-[200px] truncate">Hello there! How
                                                            are
                                            ...
                                            <div class="ti-dropdown-item relative header-box">
                                                <a href="{{ url('mail-inbox') }}"
                                                    class="flex items-center space-x-3 rtl:space-x-reverse">
                                                    <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                                                        <img src="{{ asset('build/assets/img/users/21.jpg') }}"
                                                            alt="img" class="rounded-sm">
                                                    </div>
                                                    <div class="relative w-full">
                                                        <h5
                                                            class="text-sm text-gray-800 dark:text-white font-semibold mb-1">
                                                            Sebastian</h5>
                                                        <p class="text-xs mb-1 max-w-[200px] truncate">Shall we go to
                                                            the
                                                            cafe at downtown...</p>
                                                        <p class="text-xs text-gray-400 dark:text-white/70">yesterday
                                                        </p>
                                                    </div>
                                                </a>
                                                <a aria-label="anchor" href="javascript:void(0);"
                                ...
                                <div class="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                                    <div class="grid grid-cols-3 gap-0 p-4 pt-2">
                                        ...
                                        <a href="{{ url('filemanager') }}"
                                            ...
                                            <div class="text-xs font-semibold text-gray-800 dark:text-white">File
                                                Manager</div>
                                        </a>
                                        <a href="{{ url('contacts') }}"
                                            class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                            ...
                            <div class="header-profile hs-dropdown ti-dropdown"
                                ...
                                <div class="hs-dropdown-menu ti-dropdown-menu border-0 w-[20rem]"
                                    ...
                                    <div class="ti-dropdown-header !bg-primary flex">
                                        ...
                                        <div>
                                            <p class="ti-dropdown-header-title !text-white">{{ auth()->user()->name }}
                                            </p>
                                            <p class="ti-dropdown-header-content !text-white/50">{{ $role }}
                                            </p>
                                        </div>
                                    </div>
