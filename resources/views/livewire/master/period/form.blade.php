                        ...
                        <div class="grid grid-rows-2 grid-flow-col gap-4">
                            <div class="row-span-2">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select wire:model="term_id" class="ti-form-select">
                                ...
                                <div class="mb-4">
                                    <label for="input-label" class="ti-form-label">Period Name</label>
                                    <input type="text" class="ti-form-input" placeholder="Period Name"
                                ...
                                <div class="mb-4">
                                    <label for="input-label" class="ti-form-label">Group Name</label>
