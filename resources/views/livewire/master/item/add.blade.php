                    ...
                    <div class="ti-modal-body">
                        <div class="grid grid-rows-2 grid-flow-col gap-4">
                            <div class="row-span-2">
                                <div class="mb-4">
                                    <label for="input-label" class="ti-form-label">Group</label>
                                    <input type="text" class="ti-form-input" placeholder="group name"
                                        wire:model="group">
                                    @error('group')
                                ...
                                <div class="mb-4">
                                    <label for="input-label" class="ti-form-label">Sub Group</label>
                                    <input type="text" class="ti-form-input" placeholder="sub group name"
                                        wire:model="sub_group">
                                    @error('sub_group')
                                        <p class="text-sm text-red-600 mt-2 dark:text-red-500" id="hs-input-helper-text">
                                            {{ $message }}
                                        </p>
                            ...
                            <div class="row-span-2">
                                <div class="mb-4">
                                    <label for="input-label" class="ti-form-label">Item Name</label>
                                    <input type="text" class="ti-form-input" placeholder="item name"
                                        wire:model="name">
                                    @error('name')
                                        <p class="text-sm text-red-600 mt-2 dark:text-red-500" id="hs-input-helper-text">
                                            {{ $message }}
                                ...
                                <div class="mb-4">
                                    <label for="input-label" class="ti-form-label">Item Code</label>
                                    <input type="text" class="ti-form-input" placeholder="item name"
                                        wire:model="code">
                                    @error('code')
                                        <p class="text-sm text-red-600 mt-2 dark:text-red-500" id="hs-input-helper-text">
