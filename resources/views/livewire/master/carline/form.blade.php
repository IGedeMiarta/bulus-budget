                        ...
                        <div class="grid grid-rows-2 grid-flow-col gap-4">
                            <div class="row-span-2">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="ti-form-input" placeholder="category name"
                                        wire:model="category">
                                    @error('category')
                                ...
                                <div class="mb-4">
                                    <label for="input-label" class="ti-form-label">Commodity</label>
                                    <input type="text" class="ti-form-input" placeholder="Commodity name"
                                ...
                                <div class="mb-4">
                                    <label for="input-label" class="ti-form-label">Destination</label>
                                    <input type="text" class="ti-form-input" placeholder="Destination"
                            ...
                            <div class="row-span-2">
                                <div class="mb-4">
                                    <label for="input-label" class="ti-form-label">Carmaker</label>
                                    <input type="text" class="ti-form-input" placeholder="Carmaker"
                                        wire:model="carmaker">
                                    @error('carmaker')
                                        <p class="text-sm text-red-600 mt-2 dark:text-red-500" id="hs-input-helper-text">
                                            {{ $message }}
                                ...
                                <div class="mb-4">
                                    <label for="input-label" class="ti-form-label">Carline</label>
                                    <input type="text" class="ti-form-input" placeholder="carline"
                                        wire:model="carline">
                                    @error('carline')
                                        <p class="text-sm text-red-600 mt-2 dark:text-red-500" id="hs-input-helper-text">
                                            {{ $message }}
                                ...
                                <div class="mb-4">
                                    <label for="input-label" class="ti-form-label">Model Year</label>
                                    <input type="number" class="ti-form-input" placeholder="2020" wire:model="year">
                                    @error('year')
                                        <p class="text-sm text-red-600 mt-2 dark:text-red-500" id="hs-input-helper-text">
                                            {{ $message }}
                                        </p>
