                        ...
                        <ul class="main-menu">
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide"><a href="{{url('list-group')}}" class="side-menu__item">List Group</a></li>
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide"><a href="{{url('form-elements')}}" class="side-menu__item">Form Elements</a></li>
                                    <li class="slide"><a href="{{url('advanced-forms')}}" class="side-menu__item">Advanced Forms</a></li>
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">File Manager<i
                                        ...
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('filemanager')}}" class="side-menu__item">File Manager</a>
                                            </li>
                                            <li class="slide"><a href="{{url('filemanager-list')}}" class="side-menu__item">File Manager
                                                    List</a></li>
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide"><a href="{{url('tooltip-popovers')}}" class="side-menu__item">Tooltips &amp; Popovers</a></li>
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Tables<i class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('tables')}}" class="side-menu__item">Basic Tables</a></li>
                                            <li class="slide"><a href="{{url('datatables')}}" class="side-menu__item">Data Tables</a></li>
                                            <li class="slide"><a href="{{url('edittable')}}" class="side-menu__item">Edit Tables</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide"><a href="{{url('apex-charts')}}" class="side-menu__item">Apex Charts</a></li>
                                    <li class="slide"><a href="{{url('chartjs')}}" class="side-menu__item">Chart JS</a></li>
                                    <li class="slide"><a href="{{url('echartjs')}}" class="side-menu__item">Echart Js</a></li>
                                </ul>
                            </li>
                            <!-- End::slide -->
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Mail<i
                                                class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('mail-inbox')}}" class="side-menu__item">Mail Inbox</a></li>
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Ecommerce<i
                                        ...
                                        <ul class="slide-menu child2">
                                            ...
                                            <li class="slide"><a href="{{url('wishlist')}}" class="side-menu__item">Wishlist</a></li>
                                        </ul>
                                    </li>
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Two-Step
                                        ...
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('verification')}}" class="side-menu__item">Basic</a></li>
                                            <li class="slide"><a href="{{url('verification-cover')}}" class="side-menu__item">Cover-1</a>
                                            </li>
                                            <li class="slide"><a href="{{url('verification-cover2')}}" class="side-menu__item">Cover-2</a>
                                            </li>
                                        </ul>
                                    </li>
